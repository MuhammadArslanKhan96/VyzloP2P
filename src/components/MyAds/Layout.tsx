...
export default function CreateLayout({
  ...
  return (
    <form
      ...
      className="flex  flex-col px-8 py-6 justify-center items-center gap-x-6 mx-auto w-full xl:w-[80%] rounded-lg bg-white mt-4"
    >
      ...
      <div className="w-full flex justify-end items-center">
        <div
          className="text-blue-500 bg-white px-3 py-1 cursor-pointer rounded border border-blue-500 mr-2"
          onClick={prevStep}
        >
          Previous
        </div>
        {activeModel === 2 ? (
          ...
          <div
            className="bg-[#05379A] px-3 py-1 border cursor-pointer rounded text-white hover:bg-opacity-75"
            onClick={nextStep}
          >
            Next
          </div>
