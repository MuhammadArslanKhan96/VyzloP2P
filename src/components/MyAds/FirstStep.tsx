...
export default function FirstStep({ updateFields, networkData }: { updateFields: (e: { target: { name: string, value: any } }) => void, networkData: any }) {
    return (
            ...
            <Box className="w-full flex flex-col justify-center  items-center mt-10 ">
                ...
                <Box>
                    ...
                    <Box sx={{ m: 1, minWidth: 800 }}>
                        ...
                        <PaymentMethodTags mutlipleMethod={(methods: string[]) => updateFields({ target: { name: "paymentMethod", value: methods } })} />
