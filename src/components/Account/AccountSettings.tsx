...
const AccountSettings = () => {
    ...
    return (
        <>
            <Header toggleAccMenu={toggleAccMenu} openAccMenu={openAccMenu} openMenu={openMenu} toggleMenu={toggleMenu} />
                    ...
                    <div className="p-6">
                        <div className="bg-white px-2 py-4 rounded-md border border-gray-300 flex justify-between max-sm:gap-2 whitespace-nowrap">
                            ...
                            <div className="flex items-center gap-2">
                                <button className="text-[12px] lg:text-xl flex items-center gap-2"><Image src={sidebarIcon1} alt="sideBarIcon1" width={20} height={20} /></button>
                                <IoIosArrowForward className="text-gray-400" />
                                <button className="text-[12px] lg:text-xl flex items-center gap-2">P2P</button>
                                <IoIosArrowForward className="text-gray-400" />
                                <h1 className="text-gray-400 text-[12px] lg:text-xl">Settings</h1>
                            </div>
                        </div>
                    </div>
                    <Settings />
